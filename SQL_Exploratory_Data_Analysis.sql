-- Exploratory Data Analysis (EDA) of data from March 11th 2020 to March 6th 2023

SELECT * 
FROM layoffs_staging2;

-- Max number of employees laid off by any company per industry
SELECT MAX(total_laid_off), MAX(percentage_laid_off)
FROM layoffs_staging2;

-- Highest number of employees laid off by a single company in any industry
